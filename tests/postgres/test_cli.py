...
async def test_lifespan_runs_startup_and_healthz_stays_database_free(
    ...
    async with lifespan(app):
        ...
        # Sorted, and now nineteen: 0b1's three, 0b2's C8 adds core.token.issue and
        ...
        # core.runtime.run, and run 1a0 adds core.module.install. Sorted by the
        # name string, so the two core.approval.* names lead ("approval" before
        # "audit"), the three core.operation.* names follow core.module.install,
        # which itself sits between core.audit.list and core.operation.get,
